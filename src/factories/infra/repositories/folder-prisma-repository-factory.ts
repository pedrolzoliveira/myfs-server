...
export const FolderPrismaRepositoryFactory: Factory<FindFolderRepository & FindAllFolderRepository & UpdateFolderRepository & CreateFolderRepository & DeleteFolderRepository> = {
  async create() {
